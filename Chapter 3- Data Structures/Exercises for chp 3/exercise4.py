...
print(f"Hola!,",dinner_guest[0],"I'd like to invite you to dinner as your my favorite colleague")
print(f"Hola!,",dinner_guest[1],"I'd like to invite you to dinner as your my bestie from childhood")
print(f"Hola!,",dinner_guest[2],"I'd like to invite you to dinner because your my family friend")
